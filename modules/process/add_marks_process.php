...
$query01="select * from student_marks where stud_id='$index' AND gradebk_id='$gradebk_id'";
$result01=mysqli_query($con1,$query01);
$Num_Of_Recs01=mysqli_num_rows($result01);
if ($Num_Of_Recs01 == 0){

$query20="INSERT INTO student_marks (stud_id,cat_1,cat_2,mid_term,end_term,term_id,subject_id,gradebk_id)
VALUES ('$index','$val','0','0','0','$term_id','$subject_id','$gradebk_id')";
$result20=mysqli_query($con1,$query20) or die(mysqli_error($con1));
}
}
//kwata va
