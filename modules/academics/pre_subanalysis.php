...
<p> <h2 class="title">Select appropriate details here</h2>
		...
		<form action="/sms/index.php?view=subject_analysis" method="post" target ="_blank" name="frmStdDetails" id="frmStdDetails">
		<br>
    <table width="550" border="0" align="center" cellpadding="5" cellspacing="1" class="entryTable">
			...
			<td><select name="class_name" class="box" id="exam_id">
            <?php
			...
			<td><input type="text" name="year_name" class="box" id="yearpicker">
			</td>
						</tr>			
